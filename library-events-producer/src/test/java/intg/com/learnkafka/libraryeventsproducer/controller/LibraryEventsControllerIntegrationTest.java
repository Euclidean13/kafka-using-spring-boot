...
public class LibraryEventsControllerIntegrationTest {
    ...
    @Test
    @Timeout(5) // Wait for five seconds before it completes the execution of the test in order to solve Kafka async
    void postLibraryEvent() {
        ...
        String expectedRecord = "{\"libraryEventId\":null,\"libraryEventType\":\"NEW\",\"book\":{\"bookId\":123," +
                "\"bookName\":\"Kafka using springboot\",\"bookAuthor\":\"Dilip\"}}";
    ...
    void putLibraryEvent() {
        ...
        ConsumerRecord<Integer, String> consumerRecord = KafkaTestUtils.getSingleRecord(consumer, "library-events");
        String expectedRecord = "{\"libraryEventId\":123,\"libraryEventType\":\"UPDATE\",\"book\":{\"bookId\":456," +
                "\"bookName\":\"Kafka using springboot\",\"bookAuthor\":\"Dilip\"}}";
        String value = consumerRecord.value();
        assertEquals(expectedRecord, value);
    }
